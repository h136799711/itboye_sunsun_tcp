...
gateway="aq118_gateway"
worker="aq118_worker"
register="start_aq118_register.php"
...
echo "aq118 gateway and worker is need restart process....."
echo -e "$timestamp""aq118 workerman gateway and worker restart\n" >> ./aq118.log

./stop.sh && ./start.sh

else
    echo "aq118 gateway and worker is runing....."
fi