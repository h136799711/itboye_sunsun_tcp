...
echo "transfer_station gateway and worker is need restart process....."
echo -e "$timestamp""transfer_station workerman gateway and worker restart\n" >> ./transfer_station.log

./stop.sh && ./start.sh

else
    echo "transfer_station gateway and worker is runing....."
fi