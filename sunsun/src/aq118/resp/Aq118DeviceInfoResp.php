 ...
 */
class Aq118DeviceInfoResp extends BaseDeviceInfoClientResp implements ToDbEntityArrayInterface
{
    ...
    public function __construct(Aq118DeviceInfoReq $req = null)
    {
        parent::__construct($req);
        $this->setRespType(Aq118RespType::DeviceInfo);
    }
