 ...
 */
class Aq136DeviceInfoResp extends BaseDeviceInfoClientResp implements ToDbEntityArrayInterface
{
    ...
    public function __construct(Aq136DeviceInfoReq $req = null)
    {
        parent::__construct($req);
        $this->setRespType(Aq136RespType::DeviceInfo);
    }
