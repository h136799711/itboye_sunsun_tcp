...
/**
 * Class FeederV2DeviceInfoResp
 * 设备状态响应包
 * @package sunsun\feederV2\resp
 */
class FeederV2DeviceInfoResp extends BaseDeviceInfoClientResp implements ToDbEntityArrayInterface
{
    ...
    public function __construct(FeederV2DeviceInfoReq $req = null)
    {
        ...
        $this->setRespType(FeederV2RespType::DeviceInfo);
        $this->setUpdState(-1);
    }
